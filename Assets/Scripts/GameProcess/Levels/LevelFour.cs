...
public class LevelFour : MonoBehaviour, ILevel
{
    // planet
    GameObject[] planets = new GameObject[32];
    ...
    public float waveAsteroidWait = 28f;
    // fuel
    ...
    void SpawnFreeze()
    {
        ...
        Instantiate(freeze, spawnObjectPosition, Quaternion.Euler(-90, 180, 0));
    }
}
